    ...
    // flake-utils.lib.eachSystem ["x86_64-linux"] (
      system: let
        pkgs =
          ...
          // {rootProjectDir = builtins.toString ./.;};
      ...
      in {
        devShell = pkgs.devshell.mkShell {
          ...
          commands = import ./dev-commands/all-commands.nix {inherit pkgs;};
          env = with pkgs; [
            {
              name = "ANDROID_HOME";
              value = ANDROID_HOME;
            ...
            {
              name = "PATH";
              prefix = "/home/srghma/projects/nativescript-cli/bin/";
            }
          ];
          packages = with pkgs; [
            arion
...
# f = builtins.getFlake "/home/srghma/projects/nativescript-testapp"
